...
export const Compra = () => {
  ...
  // Obtener el usuario una sola vez al montar el componente
  ...
  useEffect(() => {
    ...
    if (usuario) {
      const carritoGuardado =
        JSON.parse(localStorage.getItem(`carrito_${usuario.email}`)) || {};
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-8">
          ...
          {!Object.keys(carrito).length ? (
            <div
              className="alert alert-warning d-flex align-items-center animate__animated animate__fadeIn"
              role="alert"
            >
                ...
                >
                  ...
                  <div className="flex-grow-1">
                    ...
                    <p className="mb-0 text-muted">
                      Cantidad:{" "}
                      <span className="fw-medium">{producto.cantidad}</span>
                    </p>
                  </div>
        ...
        <div className="col-lg-4">
          <div
            className="card border-0 shadow-lg p-4 rounded-3 sticky-top"
            style={{ top: "20px" }}
          >
